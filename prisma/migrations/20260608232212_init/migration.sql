...
-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('CHARACTER', 'PROP', 'ENVIRONMENT', 'VEHICLE', 'OTHER');

-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'REVIEW', 'APPROVED', 'COMPLETE');

-- CreateEnum
CREATE TYPE "ShotStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'REVIEW', 'APPROVED', 'COMPLETE');
...
CREATE TABLE "Asset" (
    ...
    "status" "AssetStatus" NOT NULL DEFAULT 'NOT_STARTED',
...
CREATE TABLE "Shot" (
    ...
    "code" TEXT NOT NULL,
    "description" TEXT,
    "status" "ShotStatus" NOT NULL DEFAULT 'NOT_STARTED',
    "projectId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "Shot_deletedAt_idx" ON "Shot"("deletedAt");

-- CreateIndex
CREATE INDEX "Shot_projectId_status_idx" ON "Shot"("projectId", "status");
...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_shotId_fkey" FOREIGN KEY ("shotId") REFERENCES "Shot"("id") ON DELETE SET NULL ON UPDATE CASCADE;
